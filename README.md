...
ごちゃごちゃしてきたので色々整理してみました。

### リポジトリについて
* Qitta記事で利用しているデータやipynbファイルをおいてあります。
* notebooks: 記事連動のコード
* data: 利用しているデータ
* tokenizer: 利用しているトークナイザー
* model: 学習済みモデル
* data, tokenizer, modelディレクトリは必要に応じて位置を変更してください
* 必要に応じてご利用ください。
...
* sample_41.ipynb: [GPTタイプ編・事前学習２/Transformer実装](https://qiita.com/AzukiImo/items/bca5d230ebfd9c406d2a)
